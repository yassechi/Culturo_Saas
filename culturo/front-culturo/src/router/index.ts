...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      meta: { requiresAuth: false, layout: 'auth', title: 'Mot de passe oublié' },
    },
    {
      path: '/reinitialiser-mot-de-passe',
      name: 'reset-password',
      component: () => import('@/views/ResetPasswordView.vue'),
      meta: { requiresAuth: false, layout: 'auth', title: 'Nouveau mot de passe' },
    },
    {
      path: '/',
      redirect: '/dashboard',
    ...
    },
    {
      ...
      meta: { requiresAuth: true, roles: ['admin', 'formateur'], layout: 'main', title: 'Gestion des utilisateurs' },
    },
    {
      path: '/admin/botanique',
      name: 'admin-botanique',
      component: () => import('@/views/BotanicalCatalogView.vue'),
      meta: { requiresAuth: true, layout: 'main', title: 'Référentiel botanique' },
    },
    {
    ...
    },
    {
      ...
      meta: { requiresAuth: true, layout: 'main', title: 'Historique' },
    },
    {
      path: '/recoltes',
      name: 'harvests',
      component: () => import('@/views/HarvestHistoryView.vue'),
      meta: { requiresAuth: true, layout: 'main', title: 'Récoltes' },
    },
    {
      path: '/amendements',
      name: 'amendements',
      component: () => import('@/views/AmendementView.vue'),
      meta: { requiresAuth: true, layout: 'main', title: 'Fertilisations' },
    },
    {
      path: '/arrosages',
      name: 'waterings',
    ...
    },
    {
      ...
      meta: { requiresAuth: true, layout: 'main', title: 'Traitements' },
    },
    {
    ...
    },
    {
      ...
      meta: { requiresAuth: true, layout: 'main', title: 'Planification' },
    },
    {
      path: '/validation',
      name: 'validation',
      component: () => import('@/views/ValidationView.vue'),
      meta: { requiresAuth: true, roles: ['admin', 'formateur'], layout: 'main', title: 'Validation des saisies' },
    },
    {
      path: '/formateur/tableau-de-bord',
      name: 'trainer-dashboard',
      component: () => import('@/views/TrainerDashboardView.vue'),
      meta: { requiresAuth: true, roles: ['admin', 'formateur'], layout: 'main', title: 'Tableau de bord formateur' },
    },
    {
      path: '/plan-culture',
      name: 'culture-plan',
      component: () => import('@/views/CulturePlanView.vue'),
      meta: { requiresAuth: true, layout: 'main', title: 'Plan de culture' },
    },
    {
      path: '/observations',
      name: 'observations',
      component: () => import('@/views/ObservationsView.vue'),
      meta: { requiresAuth: true, layout: 'main', title: 'Mes observations' },
    },
    {
      path: '/403',
      name: 'forbidden',
